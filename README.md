...
- 96 孔使用八道排枪直接上样：每组 8 个样本按 A–H 纵向排列，每个样本的复孔向右连续，完成 8 行后再进入右侧下一复孔列块。切换到 384 孔时默认采用推荐的 9 mm 八道隔行路径，样本按 A/C/E/G/I/K/M/O、再 B/D/F/H/J/L/N/P 纵向填充，之后才向右换列；连续孔位模式仍可选。
